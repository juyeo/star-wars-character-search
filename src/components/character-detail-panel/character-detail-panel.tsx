    ...
    return (this.props.selectedCharacter ? 
        <div className="character-detail-panel">
            ...
            <div className="characteristic-container">
                ...
                <div className="characteristic-info">{this.props.selectedCharacter.hair_color}</div>
            </div>

            <div className="characteristic-container">
                <div className="characteristic-name">Skin color</div>
                <div className="characteristic-info">{this.props.selectedCharacter.skin_color}</div>
            </div>

            <div className="characteristic-container">
                <div className="characteristic-name">Eye color</div>
                <div className="characteristic-info">{this.props.selectedCharacter.eye_color}</div>
            </div>

            <div className="characteristic-container">
                <div className="characteristic-name">Birth Year</div>
                <div className="characteristic-info">{this.props.selectedCharacter.birth_year}</div>
            </div>

            <div className="characteristic-container">
                <div className="characteristic-name">Gender</div>
                <div className="characteristic-info">{this.props.selectedCharacter.gender}</div>
            </div>
        </div>
        :
